      ...
      >
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            <h2 className="h2 mb-4 text-4xl font-bold">
          ...
          {/* Items */}
          <div
            className="mx-auto grid max-w-sm  gap-8 md:max-w-md lg:max-w-none lg:grid-cols-3 lg:gap-16"
            data-aos-id-blocks
          >
            {/* 1st item */}
            <div
            ...
            >
              ...
              <p className="text-md text-center text-gray-700 dark:text-gray-400">
                Monitor your bots and get notified when they crash or find
            ...
            >
              ...
              <p className="text-md text-center text-gray-700 dark:text-gray-400">
                Monitor your backends and explore logs to find the root cause of
                an issue.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-md text-center text-gray-700 dark:text-gray-400">
                Index the data you scrape and get notified when something goes
                right or wrong.
              </p>
            </div>
          </div>
